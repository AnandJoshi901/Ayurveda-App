            ...
            <div className="col-lg-6 bg-image">
                ...
                <div className="col-lg-6 text-center">
                    <div className="card2 card border-0 px-4 py-5">
                        <h3 className="mb-2">Create your Herbal-Medics account</h3>
                        ...
                        {/* <div className="col-md-6"> <label className="mb-0">
                                    <h6 className="mb-0 text-sm">Customer Id</h6>
                                </label> <input className="form-control" type="number" name="customerId" onChange={(e) => onInputChange(e)}
                                value={customerId}  />
