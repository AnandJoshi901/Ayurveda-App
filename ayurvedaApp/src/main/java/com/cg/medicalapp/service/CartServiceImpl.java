...
public class CartServiceImpl implements CartService{
	...
	@Override
	public Cart deleteMedicine(int cartId, int mobileId) {
		
		Optional<Cart> c=cartRepository.findById(cartId);
		Cart cart=c.get();
		Optional<Medicine> m=medicineRepository.findById(mobileId);
	...
	@Override
	public List<Medicine> viewMedicines(int cartId) {
		Optional<Cart> c=cartRepository.findById(cartId);
		Cart cart=c.get();
