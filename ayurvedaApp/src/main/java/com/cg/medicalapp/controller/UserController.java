...
public class UserController {
    ...
    @PostMapping(value={"/updatePassword/{newpass}"})
...
//	public ResponseEntity<String> validateUser(@PathVariable int userId, @PathVariable String userName) {
//		boolean user=userService.validateUser(userId,userName);
